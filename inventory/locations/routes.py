...
def search_location():
    ...
    if not query:
        ...
        searched_locations = Location.query.filter(Location.location_name.contains(query)).all()
    return render_template('locations.html', locations=searched_locations, title='Search Result', label='Location')
